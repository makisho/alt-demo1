...
function runApp() {
    ...
    const server = new mixed_reality_extension_sdk_1.WebHost({
        ...
        permissions: [mixed_reality_extension_sdk_1.Permissions.UserInteraction, mixed_reality_extension_sdk_1.Permissions.UserTracking]
    });
    // Handle new application sessions
    server.adapter.onConnection((context, params) => new app_1.default(context, params, server.baseUrl));
}
